...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------------------");
        System.out.println("(A) BST Olusturuluyor:");
        ...
        int newData = 55;
        System.out.println("(B) " + newData + " Dugumu Ekleniyor...");
        bst.insert(newData);
        ...
        System.out.println("(C) " + searchKey + " Araniyor...");
        ...
        int deleteKey = 30;
        System.out.println("(D) " + deleteKey + " Dugumu Siliniyor (Iki Cocuklu)...");
